...
INSTALLED_APP_SHORTCUT="${HOME}/Applications/Orquestra.app"
INSTALLED_UNINSTALLER="${HOME}/Applications/Orquestra Uninstaller.app"
...
check_file "app" "installed_app_shortcut" "${INSTALLED_APP_SHORTCUT}" "false" "./scripts/install_orquestra_macos_full.sh"
check_file "app" "installed_uninstaller" "${INSTALLED_UNINSTALLER}" "false" "./scripts/install_orquestra_macos_full.sh"
